...
* **[A2A Multi-Agent Incident Response](./A2A-multi-agent-incident-response/)**: Agent-to-Agent protocol implementation with monitoring, remediation, and host agents using Strands, OpenAI, and Google ADK
* **[Cost Optimization Agent](./cost-optimization-agent/)**: Intelligent AWS cost monitoring with anomaly detection and optimization recommendations using Claude 3.5 Sonnet
* **[Customer Support Assistant VPC](./customer-support-assistant-vpc/)**: Private VPC deployment with Aurora PostgreSQL, DynamoDB, and Lambda-based APIs for secure isolated environments
* **[Gateway Schema Support Agent (ICARUS)](./gateway-schema-support-agent/)**: Automated OpenAPI schema repair and conversion for AgentCore Gateway compatibility
* **[Intelligent Event Agent](./intelligent-event-agent/)**: Agentic RAG system for AWS re:Invent sessions with knowledge base, memory, and personalized recommendations
* **[Lakehouse Agent](./lakehouse-agent/)**: Data processing with OAuth authentication, row-level security, and AI-powered Athena queries
* **[Site Reliability Agent Workshop](./site-reliability-agent-workshop/)**: re:Invent workshop for building SRE multi-agent systems with diagnostics, remediation, and prevention capabilities
* **[Slide Deck Generator Memory Agent](./slide-deck-generator-memory-agent/)**: Presentation generator demonstrating the power of agent memory for learning user preferences
* **[Visa B2B Account Payable Agent](./visa-b2b-account-payable-agent/)**: Automated procure-to-pay system with invoice extraction, PO matching, and Visa B2B payment processing
